...
export const GooglePlacesAutocompleteAndroid = forwardRef((props: any, ref) => {
    let _results = [];
    let _requests = [];
...
GooglePlacesAutocompleteAndroid.propTypes = {
...
GooglePlacesAutocompleteAndroid.defaultProps = {
...
GooglePlacesAutocompleteAndroid.displayName = 'GooglePlacesAutocompleteAndroid';

export default { GooglePlacesAutocompleteAndroid };